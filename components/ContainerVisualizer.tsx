...
// 컨테이너 라벨
const ContainerLabel: React.FC<{ index: number; position: [number, number, number]; itemCount: number }> = ({ index, position, itemCount }) => {
  return (
          ...
          <group key={containerIndex} position={[offsetX, 0, 0]}>
            ...
            {containerCount > 1 && (
              <ContainerLabel
                ...
                position={[0, container.height * SCALE + 0.5, 0]}
