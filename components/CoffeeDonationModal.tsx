...
const CoffeeDonationModal: React.FC<CoffeeDonationModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true" aria-labelledby="coffee-modal-title">
      {/* Backdrop */}
      <div
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 p-6 transform transition-all">
        ...
        {/* Header */}
        <div className="mb-6">
          <h2 id="coffee-modal-title" className="text-2xl font-black text-slate-900 mb-2">개발 현황</h2>
